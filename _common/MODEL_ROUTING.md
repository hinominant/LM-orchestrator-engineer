...
| Magi | opus | 多視点意思決定（Create/Evaluate） |
...
| data-guard | haiku | データ保護事前チェック（個人情報・本番データ・機密情報） |
...
| Magi → Sherpa → Builder | L5-L6 | Opus for Magi, Sonnet for Sherpa/Builder |
| Analyst → Magi | L4-L5 | Sonnet for Analyst, Opus for Magi |
...
2. **opusは意思決定のみ** — 重大なアーキテクチャ判断・多視点意思決定
